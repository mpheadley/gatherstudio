...
*(frustration, anxiety, embarrassment, overwhelm — pick the dominant emotion)*
...
*(This maps directly to the "How It Works" section on the site.)*
...
| Before | After |
|--------|-------|
| *(feeling/situation)* | *(feeling/situation)* |
| | |
| | |

*(This maps to testimonials, success metrics, and the closing CTA section.)*
...
*(Use everywhere: Google Business Profile, social bios, email signatures, business cards.)*

---

## Brand Soundbytes

Write variations of the one-liner for different contexts. These ensure consistent messaging across every touchpoint — not just the website.
...
> "Hi, you've reached [NAME] at [BUSINESS]. We help [TYPE OF CUSTOMER] [RESULT]. Leave a message and we'll call you back within [TIMEFRAME]."
...
**Title:** *(e.g. "The Homeowner's Plumbing Checklist: 7 Things to Check Before Calling a Pro")*
...
*(Landing page URL, hero transitional CTA, exit popup, blog sidebar — pick placement)*
...
- [ ] Social media bio written (160 char max)
- [ ] Email signature line written
- [ ] Brand descriptor written (for AI visibility / AEO consistency)

### Lead Generator
- [ ] Format chosen (checklist, PDF, quiz, etc.)
- [ ] Title written — specific and valuable, not generic
- [ ] Placement on site decided (hero transitional CTA, sidebar, etc.)
